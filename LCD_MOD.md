...
The Hyperpixel 2.1 round fits perfectly on top of Galahad AIO pump, has excelent IQ and is super bright. Using the app on this repository it is possible to create cool effects like the samples below:
